<?php
    ...
    function wp_theme_boilerplate_load_styles() {
        ...
        wp_register_style('wp_theme_boilerplate_main_style', get_template_directory_uri() . '/assets/styles/main.css');
    ...
    function wp_theme_boilerplate_load_scripts() {
        ...
        // Custom Scripts
        wp_register_script('wp_theme_boilerplate_custom_script', get_template_directory_uri() . '/assets/scripts/script.js', array('jquery'), null, true);
